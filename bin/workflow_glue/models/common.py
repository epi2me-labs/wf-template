...
class RunStats:
    ...
    total_reads: int | None = field(
        default=None, metadata={
            "title": "Total reads",
            "description": """Total number of reads after basecalling. This value is
            calculated from the full BAM file generated by the workflow, includes both
            aligned and unaligned reads, and excludes non-primary alignments to prevent
            double counting. It may differ from the estimate shown in the technical
            run report."""})
